  ...
  return (
    <div className="min-h-screen" style={{ background: "#201a28" }}>
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        {/* Header Section */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">Proof of Attendance Protocol</h1>
          <p className="text-white/70">Collect verifiable badges for attending Sui ecosystem events</p>
        </div>
        ...
        <div className="mb-8 space-y-4">
          <div className="flex gap-4">
            <div className="relative flex-1">
              ...
              <Input placeholder="Search POAPs by name, event, or date..." className="base-input pl-10" />
            </div>
              ...
              <div className="relative overflow-hidden">
                ...
                <Badge
                  className={`absolute top-3 right-3 font-semibold px-3 py-1 rounded-full shadow-lg ${
                    poap.status === "minted" ? "bg-green-500 text-white" : "bg-blue-500 text-white"
                  }`}
                >
              ...
              <CardContent className="space-y-4">
                ...
                {poap.status === "minted" && (
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      ...
                      style={{ width: `${(poap.holders / poap.totalMinted) * 100}%` }}
                    ></div>
                  </div>
                )}
                ...
                <div className="flex gap-2 pt-3 border-t border-gray-100">
                  {poap.status === "minted" ? (
                    ...
                    <>
                      <Button size="sm" className="flex-1 bg-gray-400 text-white rounded-xl" disabled>
                        Coming Soon
                      </Button>
                      <Button className="base-button-secondary">
                        <ExternalLink className="w-4 h-4" />
