...
import { ArrowRight, Play, Calendar, MapPin, Users, Clock, Mail, Shield, Menu, X } from "lucide-react"
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8 mb-12 p-2 sm:p-7">
              {communities.map((community, index) => (
                <div key={community.name} className="rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow group cursor-pointer min-h-[250px] sm:min-h-[400px]">
      ...
      <section className="py-12 sm:py-16 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-3xl sm:text-4xl font-medium text-gray-900 mb-4">Subscribe to our Newsletter</h2>
            <p className="text-lg sm:text-xl lg:text-2xl font-normal text-gray-600 mb-8">Stay updated with the latest Sui community events and announcements</p>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
              <div className="flex items-center justify-between mb-8 sm:mb-12">
                <div>
                  <h2 className="text-2xl sm:text-3xl font-bold text-white mb-2">Your Events</h2>
