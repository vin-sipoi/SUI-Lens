              ...
              >
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4">
                    <div
                      className={`w-12 h-12 rounded-2xl flex items-center justify-center ${getNotificationColor(notification.type)}`}
                    >
                      ...
                      <div className="flex items-start justify-between">
                        ...
                        <div className="flex items-center space-x-3 ml-4">
                          <div className="text-right">
                            ...
                            {!notification.read && (
                              <Badge className="mt-1 bg-blue-500 text-white text-xs rounded-full">New</Badge>
                            )}
                          </div>
